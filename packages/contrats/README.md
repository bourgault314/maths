...
| `src/trace-reponse.js` | `mathsgo.trace-reponse/1` | La première validation interactive (choix, entier, décimal ou fraction), séparable de la question et transmissible plus tard. |
