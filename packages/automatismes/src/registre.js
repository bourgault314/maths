...
import { GENERATEUR_RECONNAISSANCE_SOLIDES } from "./espace-et-geometrie/solides-usuels/reconnaissance.js?v=10";
import {
  GENERATEUR_VOLUME_CUBE_PAVE,
  GENERATEUR_VOLUME_CYLINDRE,
  GENERATEUR_VOLUME_PRISME,
} from "./grandeurs-et-mesures/volumes/calcul-volumes.js?v=10";
import { GENERATEUR_AFFIRMATION_DIVISIBILITE } from "./nombres-et-calculs/criteres-divisibilite/affirmation-divisibilite.js?v=10";
import { GENERATEUR_CHIFFRE_MANQUANT } from "./nombres-et-calculs/criteres-divisibilite/chiffre-manquant.js?v=10";
import { GENERATEUR_CRITERE_PRECIS } from "./nombres-et-calculs/criteres-divisibilite/critere-precis.js?v=10";
import { GENERATEUR_PARTAGE_COURT } from "./nombres-et-calculs/criteres-divisibilite/partage-court.js?v=10";
import { GENERATEUR_SELECTION_DIVISEURS } from "./nombres-et-calculs/criteres-divisibilite/selection-diviseurs.js?v=10";
import { GENERATEUR_SELECTION_NOMBRES } from "./nombres-et-calculs/criteres-divisibilite/selection-nombres.js?v=10";
