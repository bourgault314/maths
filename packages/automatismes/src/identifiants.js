...
export const MODULES_AUTOMATISMES = Object.freeze({
  ...
  DROITE_GRADUEE: "droite-graduee",
  LIRE_COORDONNEES_POINT: "lire-coordonnees-point",
  PLACER_POINT_REPERE: "placer-point-repere",
...
export const MICRO_NOTIONS_AUTOMATISMES = Object.freeze({
  ...
  ECRITURES_MULTIPLES_NOMBRE: "ecritures-multiples-nombre",
  LIRE_ABSCISSE_DROITE_GRADUEE: "lire-abscisse-droite-graduee",
  PLACER_POINT_DROITE_GRADUEE: "placer-point-droite-graduee",
  LIRE_COORDONNEES_POINT: "lire-coordonnees-point",
  PLACER_POINT_REPERE: "placer-point-repere",
...
export const CIBLES_DNB_AUTOMATISMES = Object.freeze({
  ...
  DROITE_GRADUEE: "dnb-2026-15",
  REPERAGE_PLAN: "dnb-2026-16",
...
export const IDENTITES_AUTOMATISMES = Object.freeze({
  ...
  LIRE_ABSCISSE_DROITE_GRADUEE: figerIdentite({
    domaine: DOMAINES_AUTOMATISMES.GE,
    module: MODULES_AUTOMATISMES.DROITE_GRADUEE,
    microNotion: MICRO_NOTIONS_AUTOMATISMES.LIRE_ABSCISSE_DROITE_GRADUEE,
    cible: CIBLES_DNB_AUTOMATISMES.DROITE_GRADUEE,
    codePilotage: "GE-01",
  }),
  PLACER_POINT_DROITE_GRADUEE: figerIdentite({
    domaine: DOMAINES_AUTOMATISMES.GE,
    module: MODULES_AUTOMATISMES.DROITE_GRADUEE,
    microNotion: MICRO_NOTIONS_AUTOMATISMES.PLACER_POINT_DROITE_GRADUEE,
    cible: CIBLES_DNB_AUTOMATISMES.DROITE_GRADUEE,
    codePilotage: "GE-02",
  }),
  LIRE_COORDONNEES_POINT: figerIdentite({
    domaine: DOMAINES_AUTOMATISMES.GE,
    module: MODULES_AUTOMATISMES.LIRE_COORDONNEES_POINT,
    microNotion: MICRO_NOTIONS_AUTOMATISMES.LIRE_COORDONNEES_POINT,
    cible: CIBLES_DNB_AUTOMATISMES.REPERAGE_PLAN,
    codePilotage: "GE-03",
  }),
  PLACER_POINT_REPERE: figerIdentite({
    domaine: DOMAINES_AUTOMATISMES.GE,
    module: MODULES_AUTOMATISMES.PLACER_POINT_REPERE,
    microNotion: MICRO_NOTIONS_AUTOMATISMES.PLACER_POINT_REPERE,
    cible: CIBLES_DNB_AUTOMATISMES.REPERAGE_PLAN,
    codePilotage: "GE-04",
  }),
