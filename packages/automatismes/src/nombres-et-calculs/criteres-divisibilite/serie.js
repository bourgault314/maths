...
import { GABARIT_CHIFFRE_MANQUANT } from "./chiffre-manquant.js?v=26";
import { GABARIT_CRITERE_PRECIS } from "./critere-precis.js?v=26";
import { GABARIT_PARTAGE_COURT } from "./partage-court.js?v=26";
import { GABARIT_SELECTION_DIVISEURS } from "./selection-diviseurs.js?v=26";
import { GABARIT_SELECTION_NOMBRES } from "./selection-nombres.js?v=26";
