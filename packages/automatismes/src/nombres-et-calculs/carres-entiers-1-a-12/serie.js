...
} from "./reconnaitre-carres.js?v=38";
import {
  FORMES_RETROUVER_ENTIER,
  GABARIT_RETROUVER_ENTIER_CARRE,
} from "./retrouver-entier.js?v=38";
import {
  BASES_SENS_NOTATION,
  GABARIT_SENS_NOTATION_CARRE,
} from "./sens-notation.js?v=38";
