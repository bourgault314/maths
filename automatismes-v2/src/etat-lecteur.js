...
import {
  ...
  validerTraceReponse,
} from "../../packages/contrats/src/trace-reponse.js?v=11";
import {
  TYPE_REPONSE_ENTIER_NATUREL,
  TYPE_REPONSE_CHOIX_UNIQUE,
  estEntierExact,
  estSelectionExacte,
} from "../../packages/contrats/src/question-v2.js?v=11";
import { graineDepuisTexte } from "../../packages/moteur-exercices/src/aleatoire.js";
import { creerRegistreAutomatismes } from "../../packages/automatismes/src/registre.js?v=11";
import {
