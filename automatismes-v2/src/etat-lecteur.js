import {
  SCHEMA_SEANCE,
  validerSeance,
} from "../../packages/contrats/src/seance.js?v=38";
import {
  REFERENTIEL_COMPETENCES,
  SCHEMA_TRACE_REPONSE,
  validerTraceReponse,
} from "../../packages/contrats/src/trace-reponse.js?v=38";
import {
...
import { creerRegistreAutomatismes } from "../../packages/automatismes/src/registre.js?v=38";
import {
...
} from "./registre-lecteur.js?v=38";
import { genererSerieMultinotions } from "./serie-multinotions.js?v=38";
