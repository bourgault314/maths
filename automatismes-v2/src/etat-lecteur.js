import {
  SCHEMA_SEANCE,
  validerSeance,
} from "../../packages/contrats/src/seance.js?v=33";
import {
  REFERENTIEL_COMPETENCES,
  SCHEMA_TRACE_REPONSE,
  validerTraceReponse,
} from "../../packages/contrats/src/trace-reponse.js?v=33";
import {
...
import { creerRegistreAutomatismes } from "../../packages/automatismes/src/registre.js?v=33";
import {
...
} from "./registre-lecteur.js?v=33";
import { genererSerieMultinotions } from "./serie-multinotions.js?v=33";
