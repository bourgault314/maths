import { GABARIT_RECONNAISSANCE_SOLIDES } from "../../packages/automatismes/src/espace-et-geometrie/solides-usuels/reconnaissance.js?v=54";
import {
  genererSerieSolidesUsuels,
  PAQUET_PROFILS_SOLIDES_USUELS,
  PAQUET_VUES_SOLIDES_USUELS,
} from "../../packages/automatismes/src/espace-et-geometrie/solides-usuels/serie.js?v=54";
import { GABARIT_DROITE_GRADUEE } from "../../packages/automatismes/src/espace-et-geometrie/droite-graduee/questions.js?v=54";
import {
  genererSerieDroiteGraduee,
  PAQUET_FAMILLES_DROITE_GRADUEE,
  PAQUET_PROFILS_DROITE_GRADUEE,
} from "../../packages/automatismes/src/espace-et-geometrie/droite-graduee/serie.js?v=54";
import {
...
} from "../../packages/automatismes/src/espace-et-geometrie/reperage-plan/serie.js?v=54";
import {
  GABARIT_VOLUME_CUBE_PAVE,
  GABARIT_VOLUME_CYLINDRE,
  GABARIT_VOLUME_PRISME,
} from "../../packages/automatismes/src/grandeurs-et-mesures/volumes/calcul-volumes.js?v=54";
import {
  ...
  PAQUET_VUES_VOLUMES,
} from "../../packages/automatismes/src/grandeurs-et-mesures/volumes/serie.js?v=54";
import { GABARIT_SELECTION_DIVISEURS } from "../../packages/automatismes/src/nombres-et-calculs/criteres-divisibilite/selection-diviseurs.js?v=54";
import {
  genererSerieNC01,
  PAQUET_FAMILLES_NC01,
} from "../../packages/automatismes/src/nombres-et-calculs/criteres-divisibilite/serie.js?v=54";
import { GABARIT_CALCUL_DIRECT_CARRE } from "../../packages/automatismes/src/nombres-et-calculs/carres-entiers-1-a-12/calcul-direct.js?v=54";
import {
  genererSerieNC02,
  PAQUET_FAMILLES_NC02,
} from "../../packages/automatismes/src/nombres-et-calculs/carres-entiers-1-a-12/serie.js?v=54";
import {
  GABARIT_FRACTION_VERS_DECIMAL,
} from "../../packages/automatismes/src/nombres-et-calculs/fractions-simples-decimaux/fraction-vers-decimal.js?v=54";
import {
  GABARIT_DECIMAL_VERS_FRACTION,
} from "../../packages/automatismes/src/nombres-et-calculs/fractions-simples-decimaux/decimal-vers-fraction.js?v=54";
import {
...
} from "../../packages/automatismes/src/nombres-et-calculs/fractions-simples-decimaux/serie.js?v=54";
import {
...
} from "../../packages/automatismes/src/nombres-et-calculs/ecritures-multiples-nombre/serie.js?v=54";
import {
...
} from "../../packages/moteur-exercices/src/paquets-ponderes.js?v=54";
