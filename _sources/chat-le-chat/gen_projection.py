...
<head>
  ...
  <meta name="description" content="Une activité collective de repérage spatial à projeter : toute la classe observe un placement, argumente puis vérifie les quatre cartes pas à pas.">
  ...
  <meta property="og:description" content="Douze placements inédits à observer, vérifier et corriger collectivement, carte après carte.">
    ...
    <main>
      <section class="screen home" id="home-screen">
        <div class="home-inner">
          <div class="hero">
            <div class="hero-copy">
              <span class="eyebrow">12 défis inédits · GS-CP</span>
              ...
              <p class="floor-option"><strong>Variante au sol :</strong> quatre enfants reproduisent réellement le plan dans six cerceaux ou cercles tracés au sol.</p>
