...
- `build_duplex.py` — intercale les rectos Chromium avec des versos blancs
  portant le titre du jeu, l’emblème M, la mention « Série N » (pour trier
  les cartes ramassées sans les retourner) et, en pied de carte, l’adresse du
  site dans le style exact du recto, puis vérifie leur alignement, la série et
  l’adresse de chaque verso ;
