(() => {
  ...
  function icon(name) {
    const icons = {
      fibonacci: `<svg viewBox="0 0 78 52" aria-hidden="true"><g stroke="#0b67b2" stroke-width="1.15" stroke-linejoin="round"><rect x="20" y="10" width="20" height="20" fill="#dbeafe"/><rect x="40" y="10" width="32" height="32" fill="#e0f2fe"/><rect x="20" y="30" width="12" height="12" fill="#bfdbfe"/><rect x="32" y="30" width="4" height="4" fill="#fef3c7"/><rect x="36" y="30" width="4" height="4" fill="#fed7aa"/><rect x="32" y="34" width="8" height="8" fill="#93c5fd"/></g><path d="M72 42A32 32 0 0 0 40 10A20 20 0 0 0 20 30A12 12 0 0 0 32 42A8 8 0 0 0 40 34A4 4 0 0 0 36 30A4 4 0 0 0 32 34" fill="none" stroke="#f97316" stroke-width="2.2" stroke-linecap="round"/><g fill="#083b66" font-family="Arial" font-weight="900" text-anchor="middle" dominant-baseline="central"><text x="30" y="20" font-size="8">5</text><text x="56" y="26" font-size="10">8</text><text x="26" y="36" font-size="7">3</text><text x="36" y="38" font-size="6">2</text></g></svg>`,
      thales: `<svg viewBox="0 0 82 52" aria-hidden="true"><path d="M4 44h74" stroke="#7c2d12" stroke-width="1.7" stroke-linecap="round"/><g fill="#fbbf24" stroke="#c2410c" stroke-width="1.35" stroke-linecap="round"><circle cx="10" cy="10" r="4.4"/><path d="M10 1.5v3M10 15.5v3M1.5 10h3M15.5 10h3M4 4l2.2 2.2M13.8 13.8 16 16M16 4l-2.2 2.2M6.2 13.8 4 16"/></g><path d="M15 31v13" fill="none" stroke="#9a3412" stroke-width="2.1" stroke-linecap="round"/><path d="m37 44 10-31 10 31Z" fill="#fdba74" stroke="#9a3412" stroke-width="1.6" stroke-linejoin="round"/><g fill="none" stroke="#0f766e" stroke-width="2.15" stroke-linecap="round"><path d="M15 31 26 44M47 13 73.23 44"/></g><g stroke="#f97316" stroke-width="2.5" stroke-linecap="round"><path d="M15 44h11M47 44h26.23"/></g></svg>`,
      rosette: `<svg viewBox="0 0 70 52" aria-hidden="true"><circle cx="35" cy="26" r="23" fill="#ecfdf5" stroke="#087f78" stroke-width="1.5"/><g stroke="#087f78" stroke-width="1.15" stroke-linejoin="round"><path d="M35 26Q24 17 35 3Q46 17 35 26Z" fill="#99f6e4"/><path d="M35 26Q24 17 35 3Q46 17 35 26Z" fill="#bfdbfe" transform="rotate(60 35 26)"/><path d="M35 26Q24 17 35 3Q46 17 35 26Z" fill="#99f6e4" transform="rotate(120 35 26)"/><path d="M35 26Q24 17 35 3Q46 17 35 26Z" fill="#bfdbfe" transform="rotate(180 35 26)"/><path d="M35 26Q24 17 35 3Q46 17 35 26Z" fill="#99f6e4" transform="rotate(240 35 26)"/><path d="M35 26Q24 17 35 3Q46 17 35 26Z" fill="#bfdbfe" transform="rotate(300 35 26)"/></g><g stroke="#c2410c" stroke-width=".9" stroke-linejoin="round"><path d="M35 26Q29 20 35 10Q41 20 35 26Z" fill="#fde68a" transform="rotate(30 35 26)"/><path d="M35 26Q29 20 35 10Q41 20 35 26Z" fill="#fed7aa" transform="rotate(90 35 26)"/><path d="M35 26Q29 20 35 10Q41 20 35 26Z" fill="#fde68a" transform="rotate(150 35 26)"/><path d="M35 26Q29 20 35 10Q41 20 35 26Z" fill="#fed7aa" transform="rotate(210 35 26)"/><path d="M35 26Q29 20 35 10Q41 20 35 26Z" fill="#fde68a" transform="rotate(270 35 26)"/><path d="M35 26Q29 20 35 10Q41 20 35 26Z" fill="#fed7aa" transform="rotate(330 35 26)"/></g><path d="m35 19 6 3.5v7L35 33l-6-3.5v-7Z" fill="#fff7ed" stroke="#c2410c" stroke-width="1.1"/></svg>`,
