(() => {
  ...
  const domainDesign = {
    "nombres-calculs": { icon: "pascal" },
    algebre: { icon: "splat" },
    "proportionnalite-mesures": { icon: "thales" },
    geometrie: { icon: "euclid" },
    donnees: { icon: "galton" },
    informatique: { icon: "langton" },
  ...
  function icon(name) {
    const icons = {
      pascal: `<svg viewBox="0 0 78 52" aria-hidden="true"><g stroke-width="1.05"><g fill="#0b67b2" stroke="#084c85"><circle cx="39" cy="6" r="4.8"/><circle cx="31" cy="16" r="4.8"/><circle cx="47" cy="16" r="4.8"/><circle cx="23" cy="26" r="4.8"/><circle cx="55" cy="26" r="4.8"/><circle cx="15" cy="36" r="4.8"/><circle cx="31" cy="36" r="4.8"/><circle cx="47" cy="36" r="4.8"/><circle cx="63" cy="36" r="4.8"/><circle cx="7" cy="46" r="4.8"/><circle cx="71" cy="46" r="4.8"/></g><g fill="#fbbf24" stroke="#b45309"><circle cx="39" cy="26" r="4.8"/><circle cx="23" cy="46" r="4.8"/><circle cx="39" cy="46" r="4.8"/><circle cx="55" cy="46" r="4.8"/></g></g><g font-family="Arial" font-size="5.8" font-weight="900" text-anchor="middle" dominant-baseline="central"><g fill="#fff"><text x="39" y="6">1</text><text x="31" y="16">1</text><text x="47" y="16">1</text><text x="23" y="26">1</text><text x="55" y="26">1</text><text x="15" y="36">1</text><text x="31" y="36">3</text><text x="47" y="36">3</text><text x="63" y="36">1</text><text x="7" y="46">1</text><text x="71" y="46">1</text></g><g fill="#78350f"><text x="39" y="26">2</text><text x="23" y="46">4</text><text x="39" y="46">6</text><text x="55" y="46">4</text></g></g></svg>`,
      thales: `<svg viewBox="0 0 82 52" aria-hidden="true"><path d="M5 44h72" stroke="#7c2d12" stroke-width="1.8" stroke-linecap="round"/><g fill="#fb923c" stroke="#c2410c" stroke-width="1.2"><circle cx="9" cy="8" r="4"/><path d="M9 1v3M2 8h3M13 8h3M4 3l2 2M14 3l-2 2"/></g><path d="M13 32h4v12h-4Z" fill="#fed7aa" stroke="#c2410c" stroke-width="1.5"/><path d="m40 44 4-30h7l4 30Z" fill="#fdba74" stroke="#9a3412" stroke-width="1.6" stroke-linejoin="round"/><g fill="none" stroke-linecap="round"><path d="M15 32 25 44M47.5 14 72.5 44" stroke="#0f766e" stroke-width="2.1"/><path d="M18 29 28 41M51 11 76 41" stroke="#5eead4" stroke-width="1.1" stroke-dasharray="2.5 2.5"/></g><path d="M27 25h14" stroke="#ea580c" stroke-width="1.6" stroke-linecap="round"/><path d="m37 22 4 3-4 3" fill="none" stroke="#ea580c" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
      euclid: `<svg viewBox="0 0 70 52" aria-hidden="true"><path d="m25 31 10-17.3L45 31Z" fill="#99f6e4" stroke="#087f78" stroke-width="1.8" stroke-linejoin="round"/><g fill="none" stroke-width="1.7"><circle cx="25" cy="31" r="20" stroke="#0d9488"/><circle cx="45" cy="31" r="20" stroke="#2563eb"/></g><path d="M25 31h20M25 31l10-17.3M45 31 35 13.7" fill="none" stroke="#0f766e" stroke-width="1.8"/><g stroke="#fff" stroke-width="1"><circle cx="25" cy="31" r="3" fill="#0d9488"/><circle cx="45" cy="31" r="3" fill="#2563eb"/><circle cx="35" cy="13.7" r="3.2" fill="#f97316"/></g></svg>`,
      galton: `<svg viewBox="0 0 76 54" aria-hidden="true"><path d="M38 4 8 37h60Z" fill="#fff0f5" stroke="#be3e68" stroke-width="1.3" stroke-linejoin="round"/><g fill="#be3e68"><circle cx="38" cy="10" r="1.7"/><circle cx="32" cy="17" r="1.7"/><circle cx="44" cy="17" r="1.7"/><circle cx="26" cy="24" r="1.7"/><circle cx="38" cy="24" r="1.7"/><circle cx="50" cy="24" r="1.7"/><circle cx="20" cy="31" r="1.7"/><circle cx="32" cy="31" r="1.7"/><circle cx="44" cy="31" r="1.7"/><circle cx="56" cy="31" r="1.7"/></g><path d="M38 5 32 17l6 7-6 7 6 7" fill="none" stroke="#0f766e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><circle cx="38" cy="5" r="2.8" fill="#f97316" stroke="#c2410c" stroke-width="1"/><g stroke="#9d174d" stroke-width="1"><rect x="8" y="46" width="10" height="5" fill="#fbcfe8"/><rect x="18" y="42" width="10" height="9" fill="#f9a8d4"/><rect x="28" y="37" width="10" height="14" fill="#fb7185"/><rect x="38" y="34" width="10" height="17" fill="#be3e68"/><rect x="48" y="42" width="10" height="9" fill="#f9a8d4"/><rect x="58" y="46" width="10" height="5" fill="#fbcfe8"/></g></svg>`,
      langton: `<svg viewBox="0 0 72 52" aria-hidden="true"><rect x="6" y="6" width="60" height="40" rx="3" fill="#eef0ff" stroke="#4f5fb3" stroke-width="1.3"/><g stroke="#c7d2fe" stroke-width=".8"><path d="M16 6v40M26 6v40M36 6v40M46 6v40M56 6v40M6 16h60M6 26h60M6 36h60"/></g><g fill="#4f5fb3"><rect x="16" y="26" width="10" height="10"/><rect x="26" y="26" width="10" height="10"/><rect x="26" y="16" width="10" height="10"/><rect x="36" y="16" width="10" height="10"/></g><path d="M11 41h10V31h10V21h16" fill="none" stroke="#f97316" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><g transform="translate(50 21)" stroke="#312e81" stroke-width="1.1" stroke-linecap="round"><ellipse cx="0" cy="0" rx="4.2" ry="3" fill="#facc15"/><circle cx="4.5" cy="0" r="2.2" fill="#f97316"/><path d="M-2-2.5-5-5M-2 2.5-5 5M1-2.5 0-5M1 2.5 0 5M5-1.5 7-4M5 1.5 7 4" fill="none"/></g></svg>`,
