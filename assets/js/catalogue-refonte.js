(() => {
  ...
  function icon(name) {
    const icons = {
      ...
      bars: `<svg viewBox="0 0 72 46" aria-hidden="true"><g stroke-width="1.35"><rect x="6" y="6" width="18" height="16" fill="#86efac" stroke="#15803d"/><rect x="24" y="6" width="25" height="16" fill="#bbf7d0" stroke="#15803d"/><rect x="49" y="6" width="15" height="16" fill="#fde68a" stroke="#b45309"/><rect x="6" y="22" width="12" height="16" fill="#bfdbfe" stroke="#2563eb"/><rect x="18" y="22" width="20" height="16" fill="#dbeafe" stroke="#2563eb"/><rect x="38" y="22" width="26" height="16" fill="#fed7aa" stroke="#ea580c"/></g><g font-family="Arial" font-size="8.5" font-weight="900" text-anchor="middle"><text x="15" y="17.2" fill="#166534">5</text><text x="36.5" y="17.2" fill="#166534">7</text><text x="56.5" y="17.2" fill="#92400e">4</text><text x="12" y="33.2" fill="#1d4ed8">2</text><text x="28" y="33.2" fill="#1d4ed8">4</text><text x="51" y="33.2" fill="#c2410c">x</text></g></svg>`,
