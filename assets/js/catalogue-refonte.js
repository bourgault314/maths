(() => {
  ...
  function icon(name) {
    const icons = {
      ...
      roots: `<svg viewBox="0 0 70 48" aria-hidden="true"><rect x="20" y="2" width="30" height="30" rx="2" fill="#ede9fe" stroke="#6d28d9" stroke-width="2"/><path d="M20 32v5m30-5v5M20 36h30" fill="none" stroke="#f97316" stroke-width="1.5" stroke-linecap="round"/><text x="35" y="22.5" text-anchor="middle" fill="#5b21b6" font-family="Georgia,serif" font-size="14" font-weight="700">2</text><text x="35" y="47" text-anchor="middle" fill="#c2410c" font-family="Arial" font-size="12" font-weight="900">√2</text></svg>`,
      ...
      ratio: `<svg viewBox="0 0 64 48" aria-hidden="true"><defs><marker id="ratio-arrow-orange" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0 0 6 3 0 6Z" fill="#ea580c"/></marker><marker id="ratio-arrow-teal" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0 0 6 3 0 6Z" fill="#0f766e"/></marker></defs><rect x="4" y="7" width="22" height="15" rx="4" fill="#ffedd5" stroke="#c2410c" stroke-width="1.5"/><text x="15" y="18" text-anchor="middle" fill="#9a3412" font-family="Arial" font-size="10" font-weight="900">2</text><rect x="38" y="26" width="22" height="15" rx="4" fill="#dbeafe" stroke="#1d4ed8" stroke-width="1.5"/><text x="49" y="37" text-anchor="middle" fill="#1e40af" font-family="Arial" font-size="10" font-weight="900">5</text><path d="M28 12c12-1 20 3 24 11" fill="none" stroke="#ea580c" stroke-width="2.1" stroke-linecap="round" marker-end="url(#ratio-arrow-orange)"/><path d="M36 37c-12 1-20-3-24-11" fill="none" stroke="#0f766e" stroke-width="2.1" stroke-linecap="round" marker-end="url(#ratio-arrow-teal)"/></svg>`,
      percent: `<svg viewBox="0 0 64 48" aria-hidden="true"><rect x="8" y="3" width="40" height="40" rx="2" fill="#fff" stroke="#1d4ed8" stroke-width="1.5"/><path d="M8 3h40v12H8ZM8 15h28v4H8Z" fill="#60a5fa"/><g stroke="#94a3b8" stroke-width=".45"><path d="M12 3v40M16 3v40M20 3v40M24 3v40M28 3v40M32 3v40M36 3v40M40 3v40M44 3v40M8 7h40M8 11h40M8 15h40M8 19h40M8 23h40M8 27h40M8 31h40M8 35h40M8 39h40"/></g><text x="28" y="28" text-anchor="middle" fill="#1d4ed8" stroke="#fff" stroke-width="2.4" paint-order="stroke" font-family="Arial" font-size="11" font-weight="900">37 %</text></svg>`,
      ...
      clock: `<svg viewBox="0 0 64 48" aria-hidden="true"><circle cx="28" cy="23" r="19" fill="#fff7ed" stroke="#c2410c" stroke-width="2"/><g stroke="#9a3412" stroke-width="1.3"><path d="M28 6v4M28 36v4M11 23h4M41 23h4"/></g><path d="M28 23 20 16M28 23V12" stroke="#2563eb" stroke-width="2.6" stroke-linecap="round"/><circle cx="28" cy="23" r="2.5" fill="#f97316"/><text x="48" y="44" text-anchor="middle" fill="#0f766e" font-family="Arial" font-size="6.6" font-weight="900">60 minutes</text></svg>`,
      ...
      computing: `<svg viewBox="0 0 70 48" aria-hidden="true"><defs><marker id="computing-arrow" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0 0 6 3 0 6Z" fill="#7c3aed"/></marker></defs><rect x="5" y="3" width="33" height="11" rx="3.5" fill="#bfdbfe" stroke="#2563eb" stroke-width="1.4"/><rect x="5" y="18.5" width="33" height="11" rx="3.5" fill="#fde68a" stroke="#ca8a04" stroke-width="1.4"/><rect x="5" y="34" width="33" height="11" rx="3.5" fill="#99f6e4" stroke="#0f766e" stroke-width="1.4"/><text x="21.5" y="11" text-anchor="middle" fill="#1d4ed8" font-family="Arial" font-size="7.5" font-weight="900">x ← 1</text><text x="21.5" y="26.5" text-anchor="middle" fill="#92400e" font-family="Arial" font-size="7.5" font-weight="900">x &lt; 5 ?</text><text x="21.5" y="42" text-anchor="middle" fill="#0f766e" font-family="Arial" font-size="7.5" font-weight="900">x ← x + 1</text><path d="M38 39.5c24 0 24-31 3-31" fill="none" stroke="#7c3aed" stroke-width="1.8" stroke-linecap="round" marker-end="url(#computing-arrow)"/></svg>`,
