(() => {
  ...
  function icon(name) {
    const icons = {
      ...
      "equal-volume-vase": `<svg viewBox="0 0 94 52" aria-hidden="true"><svg x="0" y="0" width="46" height="52" viewBox="10 0 56 52"><defs><clipPath id="mathsgo-equal-volume-vase"><path d="M32 5h12v8c0 4 2 6 7 9 7 4 11 10 10 17-1 7-6 10-14 10H29c-8 0-13-3-14-10-1-7 3-13 10-17 5-3 7-5 7-9Z"/></clipPath></defs><g clip-path="url(#mathsgo-equal-volume-vase)"><path d="M12 5h52v21.3H12Z" fill="#38bdf8"/><path d="M12 26.3h52v4.9H12Z" fill="#2dd4bf"/><path d="M12 31.2h52v4H12Z" fill="#fb923c"/><path d="M12 35.2h52V39H12Z" fill="#38bdf8"/><path d="M12 39h52v4.1H12Z" fill="#2dd4bf"/><path d="M12 43.1h52V49H12Z" fill="#fb923c"/><g stroke="#fff" stroke-width="1.05" opacity=".92"><path d="M12 26.3h52M12 31.2h52M12 35.2h52M12 39h52M12 43.1h52"/></g></g><path d="M32 5h12v8c0 4 2 6 7 9 7 4 11 10 10 17-1 7-6 10-14 10H29c-8 0-13-3-14-10-1-7 3-13 10-17 5-3 7-5 7-9Z" fill="none" stroke="#0b67b2" stroke-width="1.8" stroke-linejoin="round"/><path d="M29 4h18" stroke="#f58220" stroke-width="2.6" stroke-linecap="round"/></svg><g fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M50 46h41M50 46V7" stroke="#475569" stroke-width="1.25"/><path d="m88 43 3 3-3 3M47 10l3-3 3 3" stroke="#475569" stroke-width="1.2"/><path d="M51.5 45.5c4.5-3.3 9-6.8 13-8.6s8.5-4.4 13-6.7c3.7-1.9 5.3-2.4 6.5-4.2 3.2-5 5.5-12.6 6.5-17.5" stroke="#f58220" stroke-width="2.25"/></g><g fill="#08aaa5" stroke="#fff" stroke-width=".8"><circle cx="58" cy="40.4" r="1.8"/><circle cx="64.5" cy="36.9" r="1.8"/><circle cx="71" cy="33.6" r="1.8"/><circle cx="77.5" cy="30.2" r="1.8"/><circle cx="84" cy="26" r="1.8"/></g><g fill="#475569" font-family="Arial, sans-serif" font-size="6.5" font-weight="800"><text x="88" y="51">V</text><text x="43.5" y="10">h</text></g></svg>`,
      ...
      automatismes: `<svg viewBox="0 0 64 64" aria-hidden="true"><path d="m18 53 6-43h16l6 43Z" fill="#eff6ff" stroke="#0b67b2" stroke-width="2.4" stroke-linejoin="round"/><g stroke="#08aaa5" stroke-width="1.7" stroke-linecap="round"><path d="M28 20h9M27 26h9M26 32h8M25 38h8"/></g><path d="M32 45 40 13" fill="none" stroke="#f58220" stroke-width="3.2" stroke-linecap="round"/><rect x="33.3" y="23" width="7" height="5.5" rx="1.4" transform="rotate(14 36.8 25.8)" fill="#f9bf3b" stroke="#a85b08" stroke-width="1.2"/><circle cx="32" cy="45" r="3.1" fill="#f58220" stroke="#a8440b" stroke-width="1.2"/><path d="M15 53h34v6H15Z" fill="#0b67b2" stroke="#063f86" stroke-width="1.8" stroke-linejoin="round"/></svg>`,
