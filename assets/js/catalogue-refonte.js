(() => {
  ...
  function icon(name) {
    const icons = {
      ...
      truchet: `<svg viewBox="0 0 76 52" aria-hidden="true"><g fill="#ecfdf5" stroke="#0f766e" stroke-width="1.05"><rect x="8" y="6" width="20" height="20"/><rect x="28" y="6" width="20" height="20" fill="#e0f2fe"/><rect x="48" y="6" width="20" height="20"/><rect x="8" y="26" width="20" height="20" fill="#e0f2fe"/><rect x="28" y="26" width="20" height="20"/><rect x="48" y="26" width="20" height="20" fill="#e0f2fe"/></g><g fill="none" stroke-linecap="round" stroke-width="3"><g stroke="#087f78"><path d="M8 16A10 10 0 0 0 18 6M18 26A10 10 0 0 0 28 16"/><path d="M38 6A10 10 0 0 0 48 16M28 16A10 10 0 0 0 38 26"/><path d="M48 16A10 10 0 0 0 58 26M58 6A10 10 0 0 0 68 16"/><path d="M18 26A10 10 0 0 0 28 36M8 36A10 10 0 0 0 18 46"/><path d="M28 36A10 10 0 0 0 38 46M38 26A10 10 0 0 0 48 36"/><path d="M58 26A10 10 0 0 0 68 36M48 36A10 10 0 0 0 58 46"/></g><path d="M18 6A10 10 0 0 1 28 16M28 36A10 10 0 0 1 38 26M48 36A10 10 0 0 1 58 26" stroke="#f97316"/></g></svg>`,
