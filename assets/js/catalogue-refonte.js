(() => {
  ...
  function icon(name) {
    const icons = {
      ...
      "equal-volume-vase": `<svg viewBox="0 0 98 52" aria-hidden="true"><svg x="0" y="0" width="47" height="52" viewBox="10 0 56 52"><defs><clipPath id="mathsgo-equal-volume-vase"><path d="M32 5h12v8c0 4 2 6 7 9 7 4 11 10 10 17-1 7-6 10-14 10H29c-8 0-13-3-14-10-1-7 3-13 10-17 5-3 7-5 7-9Z"/></clipPath></defs><g clip-path="url(#mathsgo-equal-volume-vase)"><path d="M12 5h52v21.3H12Z" fill="#38bdf8"/><path d="M12 26.3h52v4.9H12Z" fill="#2dd4bf"/><path d="M12 31.2h52v4H12Z" fill="#fb923c"/><path d="M12 35.2h52V39H12Z" fill="#38bdf8"/><path d="M12 39h52v4.1H12Z" fill="#2dd4bf"/><path d="M12 43.1h52V49H12Z" fill="#fb923c"/><g stroke="#fff" stroke-width="1.05" opacity=".92"><path d="M12 26.3h52M12 31.2h52M12 35.2h52M12 39h52M12 43.1h52"/></g></g><path d="M32 5h12v8c0 4 2 6 7 9 7 4 11 10 10 17-1 7-6 10-14 10H29c-8 0-13-3-14-10-1-7 3-13 10-17 5-3 7-5 7-9Z" fill="none" stroke="#0b67b2" stroke-width="1.8" stroke-linejoin="round"/><path d="M29 4h18" stroke="#f58220" stroke-width="2.6" stroke-linecap="round"/></svg><g fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M51 46h42M51 46V7" stroke="#475569" stroke-width="1.25"/><path d="m90 43 3 3-3 3M48 10l3-3 3 3" stroke="#475569" stroke-width="1.2"/><path d="M52.5 45.5C54 42.7 56 41.2 59 40.4c5-1.6 11-4.4 19.5-10.2 3-2 5.7-2.7 6.5-4.2 3.3-6.1 5.8-13.3 7-17.5" stroke="#f58220" stroke-width="2.25"/></g><g fill="#08aaa5" stroke="#fff" stroke-width=".8"><circle cx="59" cy="40.4" r="1.8"/><circle cx="65.5" cy="36.9" r="1.8"/><circle cx="72" cy="33.6" r="1.8"/><circle cx="78.5" cy="30.2" r="1.8"/><circle cx="85" cy="26" r="1.8"/></g><g fill="#475569" font-family="Arial, sans-serif" font-size="6.5" font-style="italic" font-weight="800"><text x="94" y="51">V</text><text x="44" y="7">h</text></g></svg>`,
