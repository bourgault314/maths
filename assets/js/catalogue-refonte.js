(() => {
  ...
  function icon(name) {
    const icons = {
      ...
      powers: `<svg viewBox="0 0 100 54" aria-hidden="true"><g stroke="#4c1d95" stroke-width="1.25"><rect x="4" y="35" width="11" height="11" rx="1.8" fill="#c4b5fd"/><rect x="24" y="35" width="11" height="11" rx="1.8" fill="#a78bfa"/><rect x="35" y="35" width="11" height="11" rx="1.8" fill="#a78bfa"/><rect x="56" y="24" width="11" height="11" rx="1.8" fill="#8b5cf6"/><rect x="67" y="24" width="11" height="11" rx="1.8" fill="#8b5cf6"/><rect x="56" y="35" width="11" height="11" rx="1.8" fill="#8b5cf6"/><rect x="67" y="35" width="11" height="11" rx="1.8" fill="#8b5cf6"/></g><g fill="#5b21b6" font-family="Arial" font-weight="900" text-anchor="middle"><text x="9.5" y="27" font-size="9.5">2⁰</text><text x="35" y="27" font-size="9.5">2¹</text><text x="67" y="17" font-size="10">2²</text><text x="91" y="43" font-size="16">?</text></g></svg>`,
      roots: `<svg viewBox="0 0 70 54" aria-hidden="true"><rect x="20" y="2" width="30" height="30" rx="3" fill="#ede9fe" stroke="#6d28d9" stroke-width="2"/><text x="35" y="22.5" text-anchor="middle" fill="#5b21b6" font-family="Georgia,serif" font-size="14" font-weight="700">2</text><text x="35" y="49" text-anchor="middle" fill="#c2410c" font-family="Georgia,serif" font-size="15" font-weight="700">√2</text></svg>`,
      ...
      conversions: `<svg viewBox="0 0 78 50" aria-hidden="true"><rect x="3" y="17" width="25" height="16" rx="5" fill="#ffedd5" stroke="#c2410c" stroke-width="1.5"/><text x="15.5" y="28.5" text-anchor="middle" fill="#9a3412" font-family="Arial" font-size="10" font-weight="900">m</text><rect x="50" y="17" width="25" height="16" rx="5" fill="#dbeafe" stroke="#1d4ed8" stroke-width="1.5"/><text x="62.5" y="28.5" text-anchor="middle" fill="#1e40af" font-family="Arial" font-size="9" font-weight="900">cm</text><path d="M29 13C36 8 44 8 49 13M45 9l4 4-5 3" fill="none" stroke="#ea580c" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"/><path d="M49 38C42 43 34 43 29 38M33 34l-4 4 5 3" fill="none" stroke="#0f766e" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
