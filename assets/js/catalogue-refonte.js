(() => {
  ...
  function icon(name) {
    const icons = {
      abacus: `<svg viewBox="0 0 108 54" aria-hidden="true"><rect x="3" y="4" width="102" height="46" rx="5" fill="#fff4cf" stroke="#9a5b12" stroke-width="2"/><path d="M8 19h92M8 36h92" stroke="#7c4810" stroke-width="1.6"/><g fill="#ef655e" stroke="#7f1d1d" stroke-width=".85"><circle cx="51" cy="19" r="3.6"/><circle cx="55.5" cy="19" r="3.6"/><circle cx="60" cy="19" r="3.6"/><circle cx="64.5" cy="19" r="3.6"/><circle cx="69" cy="19" r="3.6"/><circle cx="51" cy="36" r="3.6"/><circle cx="55.5" cy="36" r="3.6"/><circle cx="60" cy="36" r="3.6"/><circle cx="64.5" cy="36" r="3.6"/><circle cx="69" cy="36" r="3.6"/></g><g fill="#fff" stroke="#475569" stroke-width=".85"><circle cx="73.5" cy="19" r="3.6"/><circle cx="78" cy="19" r="3.6"/><circle cx="82.5" cy="19" r="3.6"/><circle cx="87" cy="19" r="3.6"/><circle cx="91.5" cy="19" r="3.6"/><circle cx="73.5" cy="36" r="3.6"/><circle cx="78" cy="36" r="3.6"/><circle cx="82.5" cy="36" r="3.6"/><circle cx="87" cy="36" r="3.6"/><circle cx="91.5" cy="36" r="3.6"/></g></svg>`,
      ...
      powers: `<svg viewBox="0 0 82 54" aria-hidden="true"><g stroke="#4c1d95" stroke-width="1.2"><rect x="3" y="36" width="12" height="12" rx="1.8" fill="#c4b5fd"/><rect x="24" y="36" width="12" height="12" rx="1.8" fill="#a78bfa"/><rect x="36" y="36" width="12" height="12" rx="1.8" fill="#a78bfa"/><rect x="57" y="36" width="12" height="12" rx="1.8" fill="#8b5cf6"/><rect x="69" y="36" width="12" height="12" rx="1.8" fill="#8b5cf6"/><rect x="57" y="23" width="12" height="13" rx="1.8" fill="#8b5cf6"/><rect x="69" y="23" width="12" height="13" rx="1.8" fill="#8b5cf6"/></g><path d="M16 42h7m29 0h5" stroke="#f97316" stroke-width="2.2" stroke-linecap="round"/><path d="m20 38 4 4-4 4m29-8 4 4-4 4" fill="none" stroke="#f97316" stroke-width="1.6" stroke-linejoin="round"/><text x="4" y="31" fill="#5b21b6" font-family="Arial" font-size="9" font-weight="900">2⁰</text><text x="24" y="31" fill="#5b21b6" font-family="Arial" font-size="9" font-weight="900">2¹</text><text x="58" y="17" fill="#5b21b6" font-family="Arial" font-size="10" font-weight="900">2²</text></svg>`,
      roots: `<svg viewBox="0 0 70 58" aria-hidden="true"><rect x="20" y="2" width="30" height="30" rx="2" fill="#ede9fe" stroke="#6d28d9" stroke-width="2"/><path d="M20 32v7m30-7v7M20 39h30" fill="none" stroke="#f97316" stroke-width="1.7" stroke-linecap="round"/><text x="35" y="22.5" text-anchor="middle" fill="#5b21b6" font-family="Georgia,serif" font-size="14" font-weight="700">2</text><text x="35" y="54" text-anchor="middle" fill="#c2410c" font-family="Arial" font-size="13" font-weight="900">√2</text></svg>`,
      ...
      ratio: `<svg viewBox="0 0 70 52" aria-hidden="true"><defs><marker id="ratio-arrow-orange" markerWidth="7" markerHeight="7" refX="6" refY="3.5" orient="auto"><path d="M0 0 7 3.5 0 7Z" fill="#ea580c"/></marker><marker id="ratio-arrow-teal" markerWidth="7" markerHeight="7" refX="6" refY="3.5" orient="auto"><path d="M0 0 7 3.5 0 7Z" fill="#0f766e"/></marker></defs><rect x="4" y="7" width="22" height="16" rx="5" fill="#ffedd5" stroke="#c2410c" stroke-width="1.5"/><text x="15" y="18.5" text-anchor="middle" fill="#9a3412" font-family="Arial" font-size="10" font-weight="900">2</text><rect x="44" y="29" width="22" height="16" rx="5" fill="#dbeafe" stroke="#1d4ed8" stroke-width="1.5"/><text x="55" y="40.5" text-anchor="middle" fill="#1e40af" font-family="Arial" font-size="10" font-weight="900">5</text><path d="M28 12C40 7 51 8 59 17" fill="none" stroke="#ea580c" stroke-width="2.2" stroke-linecap="round" marker-end="url(#ratio-arrow-orange)"/><path d="M42 40C30 45 19 43 11 34" fill="none" stroke="#0f766e" stroke-width="2.2" stroke-linecap="round" marker-end="url(#ratio-arrow-teal)"/></svg>`,
      ...
      conversions: `<svg viewBox="0 0 64 48" aria-hidden="true"><defs><marker id="conversion-arrow-orange" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0 0 6 3 0 6Z" fill="#ea580c"/></marker><marker id="conversion-arrow-teal" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0 0 6 3 0 6Z" fill="#0f766e"/></marker></defs><rect x="3" y="5" width="25" height="16" rx="5" fill="#ffedd5" stroke="#c2410c" stroke-width="1.5"/><text x="15.5" y="17" text-anchor="middle" fill="#9a3412" font-family="Arial" font-size="10" font-weight="900">m</text><rect x="36" y="27" width="25" height="16" rx="5" fill="#dbeafe" stroke="#1d4ed8" stroke-width="1.5"/><text x="48.5" y="39" text-anchor="middle" fill="#1e40af" font-family="Arial" font-size="9" font-weight="900">cm</text><path d="M31 11c10-1 17 2 20 9" fill="none" stroke="#ea580c" stroke-width="2.1" stroke-linecap="round" marker-end="url(#conversion-arrow-orange)"/><path d="M33 37c-10 1-17-2-20-9" fill="none" stroke="#0f766e" stroke-width="2.1" stroke-linecap="round" marker-end="url(#conversion-arrow-teal)"/></svg>`,
      ...
      clock: `<svg viewBox="0 0 64 48" aria-hidden="true"><circle cx="28" cy="23" r="19" fill="#fff7ed" stroke="#c2410c" stroke-width="2"/><g stroke="#9a3412" stroke-width="1.3"><path d="M28 6v4M28 36v4M11 23h4M41 23h4"/></g><path d="M28 23 20 16M28 23V12" stroke="#2563eb" stroke-width="2.6" stroke-linecap="round"/><circle cx="28" cy="23" r="2.5" fill="#f97316"/><text x="48" y="44" text-anchor="middle" fill="#0f766e" font-family="Arial" font-size="7.6" font-weight="900">60 min</text></svg>`,
      ...
      triangles: `<svg viewBox="0 0 70 48" aria-hidden="true"><path d="M10 40 31 6l31 34Z" fill="#e0f2fe" stroke="#2563eb" stroke-width="2" stroke-linejoin="round"/><g fill="none" stroke="#0d9488" stroke-width="1.45"><path d="M31 6v34M10 40 38.4 14.1M62 40 24.4 16.7"/></g><g fill="none" stroke="#f97316" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M31 35h5v5"/><path d="M0 -4h4v4" transform="translate(38.4 14.1) rotate(47.7)"/><path d="M0 -4h4v4" transform="translate(24.4 16.7) rotate(-58.3)"/></g></svg>`,
      ...
      computing: `<svg viewBox="0 0 88 48" aria-hidden="true"><defs><marker id="computing-arrow" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0 0 6 3 0 6Z" fill="#7c3aed"/></marker></defs><rect x="3" y="13" width="17" height="22" rx="5" fill="#bfdbfe" stroke="#2563eb" stroke-width="1.5"/><rect x="28" y="13" width="20" height="22" rx="5" fill="#fde68a" stroke="#ca8a04" stroke-width="1.5"/><rect x="56" y="13" width="20" height="22" rx="5" fill="#99f6e4" stroke="#0f766e" stroke-width="1.5"/><text x="11.5" y="27" text-anchor="middle" fill="#1d4ed8" font-family="Arial" font-size="9" font-weight="900">x</text><text x="38" y="27" text-anchor="middle" fill="#92400e" font-family="Arial" font-size="8.5" font-weight="900">×2</text><text x="66" y="27" text-anchor="middle" fill="#0f766e" font-family="Arial" font-size="8.5" font-weight="900">+3</text><path d="M20 24h7m21 0h7" fill="none" stroke="#7c3aed" stroke-width="1.8" stroke-linecap="round" marker-end="url(#computing-arrow)"/></svg>`,
      ...
      gears: `<svg viewBox="0 0 64 48" aria-hidden="true"><g fill="#2dd4bf" stroke="#0f766e" stroke-width="1.4"><rect x="17" y="2" width="6" height="8" rx="1"/><rect x="17" y="2" width="6" height="8" rx="1" transform="rotate(45 20 19)"/><rect x="17" y="2" width="6" height="8" rx="1" transform="rotate(90 20 19)"/><rect x="17" y="2" width="6" height="8" rx="1" transform="rotate(135 20 19)"/><rect x="17" y="2" width="6" height="8" rx="1" transform="rotate(180 20 19)"/><rect x="17" y="2" width="6" height="8" rx="1" transform="rotate(225 20 19)"/><rect x="17" y="2" width="6" height="8" rx="1" transform="rotate(270 20 19)"/><rect x="17" y="2" width="6" height="8" rx="1" transform="rotate(315 20 19)"/><circle cx="20" cy="19" r="11"/></g><circle cx="20" cy="19" r="4.3" fill="#ecfeff" stroke="#0f766e" stroke-width="1.5"/><g fill="#facc15" stroke="#b45309" stroke-width="1.2"><rect x="41.5" y="19" width="5" height="6" rx=".8"/><rect x="41.5" y="19" width="5" height="6" rx=".8" transform="rotate(45 44 31)"/><rect x="41.5" y="19" width="5" height="6" rx=".8" transform="rotate(90 44 31)"/><rect x="41.5" y="19" width="5" height="6" rx=".8" transform="rotate(135 44 31)"/><rect x="41.5" y="19" width="5" height="6" rx=".8" transform="rotate(180 44 31)"/><rect x="41.5" y="19" width="5" height="6" rx=".8" transform="rotate(225 44 31)"/><rect x="41.5" y="19" width="5" height="6" rx=".8" transform="rotate(270 44 31)"/><rect x="41.5" y="19" width="5" height="6" rx=".8" transform="rotate(315 44 31)"/><circle cx="44" cy="31" r="7.5"/></g><circle cx="44" cy="31" r="3" fill="#fffbeb" stroke="#b45309" stroke-width="1.3"/></svg>`
    };
