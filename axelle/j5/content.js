(function () {
  ...
  const mathLessons = [
    {title: "Décomposer autrement", text: "4 635 peut aussi s’écrire 46 centaines + 3 dizaines + 5 unités.", visual: {kind: "decomposition", parts: ["46 centaines", "3 dizaines", "5 unités"]}},
    ...
    {title: "Le schéma raconte le problème", text: "Une barre peut montrer une quantité connue et la partie ajoutée.", visual: {kind: "bars", rows: [{label: "Lina", parts: [{text: "32", value: 32, color: "#eaf4ff"}]}, {label: "Malo", parts: [{text: "32", value: 32, color: "#eaf4ff"}, {text: "8 de plus", value: 8, color: "#fff0df"}]}]}}
  ];
  ...
  const mathQuestions = [
    ...
    q("j5m04", "Numération", "Quel est le plus petit nombre ?", "Compare les milliers, puis les centaines.", "3 899", ["3 989", "3 899", "3 908", "3 980"], "Tous ont 3 milliers ; 3 899 possède seulement 8 centaines, c’est le plus petit.", {kind: "number-list", numbers: ["3 989", "3 899", "3 908", "3 980"]}),
    ...
    input("j5m12", "Groupes égaux", "Combien de points contient chacun des deux rectangles ?", "Tu peux calculer 3 × 4 ou 4 × 3.", ["12"], "12", "Trois rangées de quatre points, ou quatre rangées de trois points, donnent 12 points.", {kind: "groups-pair", items: [{rows: 3, cols: 4, caption: "3 rangées de 4", operation: "3 × 4"}, {rows: 4, cols: 3, caption: "4 rangées de 3", operation: "4 × 3"}]}),
    ...
    input("j5m15", "Problème", "Il y a 4 tables de 6 places et 7 tables de 4 places. Combien de places en tout ?", "Calcule les deux groupes, puis additionne.", ["52"], "52", "4 × 6 = 24 et 7 × 4 = 28 ; 24 + 28 = 52 places.", {kind: "bars", rows: [{label: "Places", parts: [{text: "4 × 6 = 24", value: 24, color: "#dff5ee"}, {text: "7 × 4 = 28", value: 28, color: "#fff0df"}]}]}),
    input("j5m16", "Comparaison", "Mia a 12 images. Sami en a trois fois autant que Mia. Combien Sami a-t-il d’images ?", "Sami possède trois groupes de 12 images.", ["36"], "36", "Sami a 3 × 12 = 36 images.", {kind: "bars", rows: [{label: "Mia", parts: [{text: "12", value: 12, color: "#eaf4ff"}]}, {label: "Sami", parts: [{text: "12", value: 12, color: "#eaf4ff"}, {text: "12", value: 12, color: "#eaf4ff"}, {text: "12", value: 12, color: "#eaf4ff"}]}]}),
    q("j5m17", "Fractions", "Quelle fraction est égale à un demi ?", "Partage chaque moitié en quatre parts plus petites.", "4/8", ["1/8", "2/8", "3/8", "4/8"], "Quatre huitièmes occupent exactement la moitié de l’unité.", {kind: "fraction-pair", items: [{label: "1/2", numerator: 1, denominator: 2, color: "#facc15"}, {label: "?", numerator: 4, denominator: 8, color: "#facc15"}]}),
