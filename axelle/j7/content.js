(function () {
  ...
  const mathLessons = [
    ...
    {title: "Écart ou total ?", text: "« 47 de moins » sert à trouver une quantité. Pour obtenir ensuite le total, il faut encore additionner les deux quantités.", visual: {kind: "bars", rows: [{label: "Noa · 186", parts: [{text: "Lila ?", value: 139, color: "#dff5ee"}, {text: "écart 47", value: 47, color: "#fff0df"}]}, {label: "Lila", parts: [{text: "?", value: 139, color: "#dff5ee"}]}]}},
  ...
  const mathQuestions = [
    ...
    q("j7m10", "Choisir l’opération", "Quelle opération permet de trouver l’écart entre 512 et 278 ?", "Un écart est une différence.", "512 − 278", ["512 + 278", "512 − 278", "512 × 278", "512 ÷ 278"], "Pour trouver la différence entre deux quantités, on soustrait la plus petite de la plus grande.", {kind: "bars", rows: [{label: "Grand · 512", parts: [{text: "278", value: 278, color: "#eaf4ff"}, {text: "écart ?", value: 234, color: "#fff0df"}]}, {label: "Petit · 278", parts: [{text: "278", value: 278, color: "#eaf4ff"}]}]}),
    input("j7m11", "Problème", "Une bibliothèque possède 245 albums. Elle en reçoit 78 puis en prête 96. Combien en reste-t-il ?", "Ajoute d’abord les albums reçus, puis retire les albums prêtés.", ["227"], "227", "245 + 78 = 323, puis 323 − 96 = 227 albums.", {kind: "steps", items: ["245 au départ", "+ 78 reçus", "− 96 prêtés", "? albums"]}),
    input("j7m12", "Comparaison", "Noa a 186 cartes. Lila en a 47 de moins. Combien Lila a-t-elle de cartes ?", "La barre de Lila est plus courte de 47.", ["139"], "139", "186 − 47 = 139 cartes.", {kind: "bars", rows: [{label: "Noa · 186", parts: [{text: "Lila ?", value: 139, color: "#dff5ee"}, {text: "écart 47", value: 47, color: "#fff0df"}]}, {label: "Lila", parts: [{text: "?", value: 139, color: "#dff5ee"}]}]}),
    input("j7m13", "Comparaison", "Combien Noa et Lila ont-ils de cartes en tout ?", "Utilise 186 et la réponse précédente : 139.", ["325"], "325", "186 + 139 = 325 cartes en tout.", {kind: "bars", rows: [{label: "Total", parts: [{text: "Noa : 186", value: 186, color: "#eaf4ff"}, {text: "Lila : 139", value: 139, color: "#dff5ee"}]}]}),
    ...
    q("j7m17", "Fractions", "Quelle fraction est égale à 1 + 2/4 ?", "Une unité vaut 4/4.", "6/4", ["3/4", "4/4", "5/4", "6/4"], "4/4 + 2/4 = 6/4.", {kind: "fraction-bar", numerator: 6, denominator: 4, units: 2, color: "#52b788", showFraction: false}),
  ...
  const frenchLessons = [
    {title: "Trois types de phrases", text: "Déclarative : elle donne une information. Interrogative : elle pose une question. Impérative : elle donne une consigne ou un conseil.", visual: {kind: "document", source: "Types", title: "Trois intentions", lines: ["Le carnet est bleu.", "Est-il bleu ?", "Prends ce carnet."]}},
