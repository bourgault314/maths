(function () {
  ...
  function lessonVisual(kind) {
    const fraction = `<div class="lesson-fraction"><span class="stacked-fraction"><b>2</b><i></i><b>3</b></span><svg class="lesson-fraction-diagram" viewBox="0 0 280 96"><rect x="12" y="18" width="246" height="58" rx="4" fill="#fff"/><rect x="12" y="18" width="164" height="58" fill="#facc15"/><rect x="12" y="18" width="246" height="58" rx="4" fill="none" stroke="#143451" stroke-width="4"/><path d="M94 18v58M176 18v58" stroke="#143451" stroke-width="3"/><text x="53" y="55" text-anchor="middle" font-size="22" font-weight="900">1</text><text x="135" y="55" text-anchor="middle" font-size="22" font-weight="900">2</text><text x="217" y="55" text-anchor="middle" font-size="22" font-weight="900">3</text></svg></div>`;
    const visuals = {
      fraction,
