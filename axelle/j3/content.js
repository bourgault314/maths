(function () {
  ...
  const math0 = [
    ...
    q("m0-02", "Fractions", "Comment lit-on cette fraction ?", "Observe le nombre du haut et celui du bas.", ["trois quarts", "deux tiers", "un quart"], 0, "3 parts sont prises quand l’unité est partagée en 4 : trois quarts.", {kind: "fraction", numerator: 3, denominator: 4, shape: "disk"}),
    ...
    q("m0-05", "Nombres entiers", "Écris ce nombre en chiffres.", "quatre-mille-six-cent-trente-cinq", ["4 635", "4 365", "4 603", "46 035"], 0, "Il y a 4 milliers, 6 centaines, 3 dizaines et 5 unités.", {kind: "place-value", number: "4 635"}),
    q("m0-06", "Nombres entiers", "Que vaut le chiffre 6 dans 4 635 ?", "Regarde la colonne des centaines.", ["6", "60", "600", "6 000"], 2, "Le 6 est dans la colonne des centaines : il vaut 600.", {kind: "place-chart", digits: [4,6,3,5], highlight: 1}),
    q("m0-07", "Nombres entiers", "Quelle autre décomposition vaut 4 635 ?", "Une centaine vaut 100 unités.", ["46 centaines + 35 unités", "46 dizaines + 35 unités", "4 centaines + 635 dizaines"], 0, "46 centaines font 4 600 ; 4 600 + 35 = 4 635.", {kind: "decomposition", text: "4 000 + 600 + 30 + 5"}),
    ...
    q("m0-09", "Calcul", "Quelle astuce permet de calculer 38 + 9 ?", "Cherche un nombre rond facile à ajouter.", ["38 + 10 − 1", "38 + 9 − 1", "38 + 8 − 1"], 0, "Ajouter 9, c’est ajouter 10 puis enlever 1.", {kind: "plus", start: 38, jump: 10, back: 1}),
    ...
    q("m0-22", "Mesures", "Complète l’égalité : 1 m = … cm", "Environ 1 m, c’est la hauteur d’une poignée de porte.", ["10", "100", "1 000"], 1, "Un mètre contient exactement 100 centimètres.", {kind: "measure", from: "1 m", to: "100 cm"}),
  ...
  const math1 = [
    ...
    q("m1-02", "Fractions", "Quelle fraction signifie « un tiers » ?", "Une seule part est prise sur trois parts égales.", ["1/2", "1/3", "2/3", "3/4"], 1, "Un tiers s’écrit 1/3.", {kind: "fraction", numerator: 1, denominator: 3, shape: "disk"}),
    ...
    q("m1-05", "Nombres entiers", "Écris ce nombre en chiffres.", "sept-mille-quatre-vingt-deux", ["7 082", "7 802", "7 820", "70 082"], 0, "Il y a 7 milliers, aucune centaine, 8 dizaines et 2 unités.", {kind: "place-value", number: "7 082"}),
    q("m1-06", "Nombres entiers", "Que vaut le chiffre 8 dans 7 082 ?", "Le 8 est dans la colonne des dizaines.", ["8", "80", "800", "8 000"], 1, "8 dizaines valent 80.", {kind: "place-chart", digits: [7,0,8,2], highlight: 2}),
    q("m1-07", "Nombres entiers", "Quelle autre décomposition vaut 7 082 ?", "Transforme d’abord les centaines en unités.", ["70 centaines + 82 unités", "70 dizaines + 82 unités", "7 centaines + 82 dizaines"], 0, "70 centaines font 7 000 ; avec 82, on obtient 7 082.", {kind: "decomposition", text: "7 000 + 80 + 2"}),
    ...
    q("m1-09", "Calcul", "Quelle astuce permet de calculer 56 + 19 ?", "Cherche la dizaine entière la plus proche de 19.", ["56 + 20 − 1", "56 + 10 − 9", "56 + 19 + 1"], 0, "Ajouter 19, c’est ajouter 20 puis enlever 1.", {kind: "plus", start: 56, jump: 20, back: 1}),
    ...
    q("m1-22", "Mesures", "Complète l’égalité : 1 km = … m", "Environ 1 km peut représenter un trajet de la maison à l’école, selon l’endroit.", ["10", "100", "1 000"], 2, "Un kilomètre contient exactement 1 000 mètres.", {kind: "measure", from: "1 km", to: "1 000 m"}),
