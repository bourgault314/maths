(function () {
  ...
  const mathLessons = [
    ...
    {title: "Comparer et calculer", text: "Même dénominateur : on compare les numérateurs. Pour additionner ou soustraire des parts de même taille, le dénominateur ne change pas.", visual: {kind: "document", source: "Fractions", title: "Deux repères", lines: ["5/8 > 3/8", "2/7 + 3/7 = 5/7", "6/8 − 2/8 = 4/8"]}},
  ...
  const mathQuestions = [
    ...
    q("j6m05", "Fractions", "Quelle fraction est représentée ?", "Compte les parts coloriées et le nombre total de parts.", "5/8", ["3/8", "5/8", "5/5", "8/5"], "Cinq parts parmi huit parts égales sont coloriées : cinq huitièmes.", {kind: "fraction-bar", numerator: 5, denominator: 8, color: "#facc15", showFraction: false}),
    ...
    q("j6m09", "Fractions équivalentes", "Quelle fraction est égale à un demi ?", "Imagine chaque moitié partagée en trois.", "3/6", ["1/6", "2/6", "3/6", "4/6"], "Trois sixièmes occupent la moitié de l’unité.", {kind: "fraction-pair", items: [{label: "1/2", numerator: 1, denominator: 2, color: "#facc15"}, {label: "?", numerator: 3, denominator: 6, color: "#facc15"}]}),
    q("j6m10", "Comparer", "Compare 5/8 et 3/8.", "Les dénominateurs sont identiques.", "5/8 > 3/8", ["5/8 < 3/8", "5/8 = 3/8", "5/8 > 3/8"], "Avec le même dénominateur, cinq parts sont plus que trois parts.", {kind: "fraction-pair", items: [{label: "5/8", numerator: 5, denominator: 8, color: "#facc15"}, {label: "3/8", numerator: 3, denominator: 8, color: "#8b5cf6"}]}),
    q("j6m11", "Comparer", "Compare 3/4 et 3/8.", "Les numérateurs sont identiques.", "3/4 > 3/8", ["3/4 < 3/8", "3/4 = 3/8", "3/4 > 3/8"], "Quand l’unité est partagée en 4, chaque part est plus grande que lorsqu’elle est partagée en 8. Donc 3/4 > 3/8.", {kind: "fraction-pair", items: [{label: "3/4", numerator: 3, denominator: 4, color: "#52b788"}, {label: "3/8", numerator: 3, denominator: 8, color: "#8b5cf6"}]}),
    q("j6m12", "Fractions équivalentes", "Compare 2/3 et 4/6.", "Chaque tiers peut être partagé en deux sixièmes.", "2/3 = 4/6", ["2/3 < 4/6", "2/3 = 4/6", "2/3 > 4/6"], "Deux tiers occupent la même longueur que quatre sixièmes.", {kind: "fraction-pair", items: [{label: "2/3", numerator: 2, denominator: 3, color: "#8b5cf6"}, {label: "4/6", numerator: 4, denominator: 6, color: "#8b5cf6"}]}),
    q("j6m13", "Additionner", "2/6 + 3/6 = ?", "Les parts ont la même taille.", "5/6", ["5/12", "5/6", "1/6", "6/6"], "Deux sixièmes plus trois sixièmes donnent cinq sixièmes.", {kind: "fraction-operation", operator: "+", items: [{label: "2/6", numerator: 2, denominator: 6, color: "#8b5cf6"}, {label: "3/6", numerator: 3, denominator: 6, color: "#52b788"}]}),
    q("j6m14", "Soustraire", "7/8 − 3/8 = ?", "On retire trois parts de même taille.", "4/8", ["4/8", "4/5", "10/8", "3/8"], "Sept huitièmes moins trois huitièmes donnent quatre huitièmes, qui valent aussi un demi.", {kind: "fraction-operation", operator: "−", items: [{label: "7/8", numerator: 7, denominator: 8, color: "#facc15"}, {label: "3/8", numerator: 3, denominator: 8, color: "#ef9a9a"}]}),
    q("j6m15", "L’unité", "Quelle fraction représente une unité entière partagée en sixièmes ?", "Toutes les parts sont prises.", "6/6", ["1/6", "5/6", "6/6", "6/1"], "Six parts sur six forment l’unité complète : 6/6 = 1.", {kind: "fraction-bar", numerator: 6, denominator: 6, color: "#8b5cf6", showFraction: false}),
    q("j6m16", "Au-delà de l’unité", "Quelle fraction est représentée ?", "Une unité complète et encore trois quarts sont coloriés.", "7/4", ["3/4", "4/7", "7/4", "1/4"], "Une unité vaut 4/4 ; avec 3/4 de plus, cela donne 7/4.", {kind: "fraction-bar", numerator: 7, denominator: 4, units: 2, color: "#52b788", showFraction: false}),
    ...
    q("j6m18", "Au-delà de l’unité", "Quelle fraction est égale à 1 + 2/6 ?", "Une unité vaut 6/6.", "8/6", ["3/6", "6/6", "7/6", "8/6"], "6/6 + 2/6 = 8/6.", {kind: "fraction-bar", numerator: 8, denominator: 6, units: 2, color: "#8b5cf6", showFraction: false}),
  ...
  const frenchQuestions = [
    ...
    q("j6f06", "Lecture", "À qui renvoie le déterminant « leur » dans « leur patience » ?", "À qui appartient cette patience ?", "à Maël et Nora", ["à l’oncle", "au vent", "à Maël et Nora", "aux feuilles"], "Le déterminant « leur » indique que la patience appartient aux deux enfants, Maël et Nora.", story),
