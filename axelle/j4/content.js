(function () {
  ...
  const mathQuestions = [
    ...
    q("j4m04", "Numération", "Quel est le plus grand nombre ?", "Compare d’abord les milliers.", "4 037", ["3 987", "4 037", "3 999", "4 007"], "Les deux nombres commençant par 4 milliers sont les plus grands ; 4 037 est supérieur à 4 007.", {kind: "number-list", numbers: ["3 987", "4 037", "3 999", "4 007"]}),
    ...
    input("j4m09", "Tables", "5 × 7 = ?", "Observe les 5 rangées de 7 points.", ["35"], "35", "5 rangées de 7 donnent 5 × 7 = 35.", {kind: "array", rows: 5, cols: 7, caption: "5 rangées de 7"}),
    ...
    input("j4m15", "Problème", "La classe récolte 128 graines lundi, 37 mardi et 25 mercredi. Combien de graines en tout ?", "Le problème comporte deux additions.", ["190"], "190", "128 + 37 = 165, puis 165 + 25 = 190 graines.", {kind: "bars", rows: [{label: "Total", parts: [{text: "128", value: 128, color: "#dff5ee"}, {text: "37", value: 37, color: "#fff0df"}, {text: "25", value: 25, color: "#f3edff"}]}]}),
    input("j4m16", "Problème", "Léa a 145 perles. Inès en a 28 de plus. Combien Inès a-t-elle de perles ?", "« 28 de plus » indique l’écart.", ["173"], "173", "Inès a 145 + 28 = 173 perles.", {kind: "bars", rows: [{label: "Léa", parts: [{text: "145", value: 145, color: "#eaf4ff"}]}, {label: "Inès", parts: [{text: "145", value: 145, color: "#eaf4ff"}, {text: "28 de plus", value: 28, color: "#fff0df"}]}]}),
    q("j4m17", "Fractions", "Quelle fraction de la bande est colorée ?", "L’unité contient 4 parts égales.", "3/4", ["1/4", "3/4", "3/3", "4/3"], "Trois parts sur les quatre parts égales sont colorées : trois quarts.", {kind: "fraction-bar", numerator: 3, denominator: 4, color: "#52b788", showFraction: false}),
    ...
    q("j4m19", "Fractions", "Quelle fraction est égale à un tiers ?", "Imagine la même unité partagée en 6 parts.", "2/6", ["1/6", "2/6", "3/6", "4/6"], "Si chaque tiers est partagé en deux, un tiers devient deux sixièmes.", {kind: "fraction-pair", items: [{label: "1/3", numerator: 1, denominator: 3, color: "#8b5cf6"}, {label: "?", numerator: 2, denominator: 6, color: "#8b5cf6"}]}),
