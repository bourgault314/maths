...
//
// Référence par défaut : a15d6ee6 (tête du lot B). Outil de migration daté, comme ses
// aînés : toute évolution ultérieure de levels.js le fera échouer légitimement — d'où
// le nom hors *.test.mjs, il n'est pas en CI.
//
...
const REF = process.argv[2] || "a15d6ee6";
