...
test("les cinq miniatures utilisent des vues fideles et adaptees aux outils", () => {
  ...
  assert.match(cataloguePage, /catalogue-refonte-data\.js\?v=multiplication-posee-20260905-1/);
...
test("la collection Splat suit l'ordre pedagogique valide", () => {
  ...
  assert.match(cataloguePage, /catalogue-refonte\.js\?v=multiplication-posee-20260905-1/);
});
