...
test("les cinq miniatures utilisent des vues fideles et adaptees aux outils", () => {
  ...
  assert.match(cataloguePage, /catalogue-refonte-data\.js\?v=geometrie-hierarchie-20260830-1/);
...
test("la collection Splat suit l'ordre pedagogique valide", () => {
  ...
  assert.match(cataloguePage, /catalogue-refonte\.js\?v=geometrie-hierarchie-20260830-1/);
});
