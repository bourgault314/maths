...
const moulin = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 320" role="img" aria-label="Moulin de Pythagore : les trois carrés remplis avec les pièces de Périgal">
  ...
  <g transform="translate(10 5)">
    ${windmillSvg({x:102,y:108,small:52,medium:104,fillAll:true,labels:true,strokeWidth:2.2})}
  </g>
  <g font-family="Segoe UI,Arial,sans-serif" text-anchor="middle">
    <text x="548" y="105" fill="#063f86" font-size="25" font-weight="800">Moulin de Pythagore</text>
    <text x="548" y="185" fill="#111827" font-size="48" font-weight="850">a² + b² = c²</text>
    <text x="548" y="232" fill="#64748b" font-size="20" font-weight="700">Périgal · 5 pièces</text>
  </g>
</svg>`;
...
const pythabarre = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 320" role="img" aria-label="PythaBarre : triangle, rédaction colorée, moulin et schéma en barres">
  ...
  <g transform="translate(-13 2)" font-family="Segoe UI,Arial,sans-serif">
    ...
    <g fill="#063f86" font-size="14" font-weight="850"><text x="305" y="80">A</text><text x="305" y="17">B</text><text x="428" y="80">C</text></g>
  ...
  <text x="360" y="112" text-anchor="middle" fill="#063f86" font-family="Segoe UI,Arial,sans-serif" font-size="19" font-weight="900">PythaBarre</text>
  ...
  <g font-family="Segoe UI,Arial,sans-serif" font-size="18" font-weight="760">
    ...
    <text x="28" y="197" fill="#334155">BC²</text><text x="68" y="197" fill="#334155">=</text><text x="86" y="197" fill="#334155">25</text>
    <text x="28" y="218" fill="#b42318">BC</text><text x="68" y="218" fill="#334155">=</text>
    ${squareRootSvg({x:86,baseline:218,radicand:"25",fontSize:18,color:"#334155",fontWeight:760})}
    <text x="129" y="218" fill="#334155">=</text><text x="147" y="218" fill="#b42318">5 cm</text>
  </g>
  ...
  <g transform="translate(235 248)" font-size="14">
    ${pythagoreanBarsSvg({x:0,y:0,width:250,height:29,strokeWidth:2})}
  </g>
</svg>`;
