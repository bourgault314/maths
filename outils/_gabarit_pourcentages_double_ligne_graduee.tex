...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south east, text=brandNavy!72, font=\sffamily\fontsize{6.8}{6.8}\selectfont]
        at ([xshift=-0.42cm,yshift=0.24cm]current page.south east) {Gabarit plastifiable};
\end{tikzpicture}%
}
