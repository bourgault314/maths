...
% On autorise proprement le premier cadre à descendre jusqu’au bas de page.
% Le cadre reste donc généré par tcolorbox/LaTeX, sans retouche du PDF.
...
\begin{tcolorbox}[colback=white, colframe=black, title=\centering\textbf{GABARIT : PROBLÈME À DEUX INCONNUES}]
    ...
    \begin{tikzpicture}[scale=0.85, every node/.style={font=\bfseries\small}]
        ...
        \path[use as bounding box] (0, 7.2) rectangle (9.0, -25.15);
