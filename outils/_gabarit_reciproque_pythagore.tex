...
\begin{tikzpicture}[scale=#1,line join=miter,line cap=round]
  ...
  \node[brandNavy,font=\bfseries\small] at (-0.16,-0.16) {$A$};
  \node[brandNavy,font=\bfseries\small] at (0.27,1.33) {$B$};
  \node[brandNavy,font=\bfseries\small] at (1.67,-0.15) {$C$};
...
\node[rounded corners=7pt,draw=brandOrange!50,fill=softOrange!55,text width=4.45cm,inner sep=5pt,align=center] at (2.77,-16.45) {\scriptsize\bfseries\color{brandNavy} Le dessin ne prouve rien : ce sont les calculs qui permettent de conclure.};
\end{tikzpicture}
\end{minipage}\hfill
...
\begin{tikzpicture}[x=1cm,y=1cm,line cap=butt,line join=miter]
  \coordinate (A) at (0,0); \coordinate (B) at (0.95,1.72); \coordinate (C) at (4.55,0.22);
  \fill[white] (A) -- (B) -- (C) -- cycle;
  \draw[brandNavy,line width=1.25pt] (A) -- (B) -- (C) -- (A);
  \draw[brandTeal,line width=4.5pt,opacity=.24] (B) -- (C);
  \draw[brandNavy,line width=1.25pt] (B) -- (C);
  \node[brandNavy!70,font=\bfseries\small] at (-0.32,-0.23) {\LowDotted{0.65}};
  \node[brandNavy!70,font=\bfseries\small] at (0.86,1.96) {\LowDotted{0.65}};
  \node[brandNavy!70,font=\bfseries\small] at (4.82,0.08) {\LowDotted{0.65}};
  \node[brandNavy!70,font=\bfseries\small] at (0.22,0.92) {\LowDotted{0.85}};
  \node[brandNavy!70,font=\bfseries\small] at (2.20,-0.18) {\LowDotted{0.85}};
  \node[brandTeal,font=\bfseries\small] at (2.82,1.27) {\LowDotted{0.85}};
\end{tikzpicture}
};
\end{tikzpicture}
\end{center}
