...
\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-5.92) {1};
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-5.78) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont Je choisis les rapports.\par\vspace{0.04cm}
{\scriptsize\bfseries\color{brandNavy} Un rapport sur chaque droite support, avec le même modèle.}};

\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-8.38) {2};
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-8.24) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont Je calcule et je compare.\par\vspace{0.04cm}
{\scriptsize\bfseries\color{brandNavy} Je calcule séparément : je ne suppose pas que c'est proportionnel.}};

\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-10.88) {3};
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-10.74) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont J'observe le résultat.\par\vspace{0.04cm}
{\scriptsize\bfseries\color{brandNavy} Différents : non-parallélisme. Égaux : disposition puis parallélisme.}};

\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-18.68) {4};
...
{\bfseries\color{brandNavy}\fontsize{9.9}{11.1}\selectfont Contexte donné par la figure}\par\vspace{0.04cm}
...
\end{minipage}\hfill
\begin{minipage}[c]{11.50cm}
Dans la configuration donnée, les points $M,A,B$ sont alignés, les points $N,A,C$ sont alignés et $A$ est le sommet commun.\par\vspace{0.10cm}
{\bfseries\color{brandNavy} Je calcule et je compare.}\par
\[
