...
\begin{tikzpicture}[scale=#1,line cap=butt,line join=miter]
  ...
  \draw[brandNavy,line width=1.20pt] (A)--(B);
  \draw[brandNavy,line width=1.20pt] (A)--(C);
  \draw[brandTeal,line width=1.34pt] (B)--(C);
  \draw[brandBlue,line width=1.24pt,densely dashed] (M)--(N);
  ...
  \node[brandBlue,font=\bfseries\scriptsize] at (3.68,0.48) {$(MN)$};
  \node[brandTeal,font=\bfseries\scriptsize] at (6.02,0.78) {$(BC)$};
\end{tikzpicture}}
...
\begin{tikzpicture}[scale=#1,line cap=butt,line join=miter]
  ...
  \draw[brandNavy,line width=1.20pt] (M)--(A)--(B);
  \draw[brandNavy,line width=1.20pt] (N)--(A)--(C);
  \draw[brandBlue,line width=1.24pt,densely dashed] (M)--(N);
  \draw[brandTeal,line width=1.34pt] (B)--(C);
  ...
  \node[brandBlue,font=\bfseries\scriptsize] at (-3.18,-0.18) {$(MN)$};
  \node[brandTeal,font=\bfseries\scriptsize] at (3.98,0.54) {$(BC)$};
\end{tikzpicture}}
...
\vspace{0.22cm}
\Section{1}{Je construis les deux rapports à comparer}\par\vspace{0.08cm}
\begin{center}
\begin{tikzpicture}
...
\vspace{0.25cm}
\Section{2}{Je calcule les deux rapports, puis je les compare}\par\vspace{0.08cm}
...
\vspace{0.24cm}
\Section{3}{J'observe le résultat, puis j'applique le bon critère}\par\vspace{0.08cm}
\begin{center}
\begin{tikzpicture}
...
\vspace{0.26cm}
\Section{4}{Deux rédactions qui expliquent le raisonnement}\par\vspace{0.09cm}
\noindent\begin{minipage}[t]{9.15cm}
\begin{tikzpicture}
...
\path[use as bounding box] (0,0) rectangle (5.20,-17.55);
\node[rounded corners=9pt,draw=brandNavy!24,fill=softBlue!30,line width=0.70pt,minimum width=5.05cm,minimum height=17.30cm,anchor=north west] at (0,0) {};
...
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-0.91) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont Je repère.\par\vspace{0.04cm}
{\scriptsize\bfseries\color{brandNavy} Sommet commun, alignements, droites à tester.}};

\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-3.75) {2};
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-3.61) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont Je choisis les rapports.\par\vspace{0.04cm}
{\scriptsize\bfseries\color{brandNavy} Un rapport sur chaque droite support, avec le même modèle.}};

\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-6.63) {3};
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-6.49) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont Je calcule.\par\vspace{0.04cm}
{\scriptsize\bfseries\color{brandNavy} Je calcule séparément : je ne suppose pas que c'est proportionnel.}};

\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-9.62) {4};
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-9.48) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont Je compare.\par\vspace{0.04cm}
{\scriptsize\bfseries\color{brandNavy} Différents : non-parallélisme. Égaux : disposition puis parallélisme.}};

\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-12.72) {5};
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-12.58) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont Je conclus.\par\vspace{0.04cm}
{\scriptsize\bfseries\color{brandNavy} J'emploie le critère adapté et je réponds à la question.}};

\node[rounded corners=7pt,draw=brandOrange!55,fill=softOrange!45,line width=0.65pt,text width=4.45cm,inner sep=5pt,align=center] at (2.55,-16.02) {\scriptsize\bfseries\color{brandNavy} Sur chaque droite : longueur du sommet jusqu'au premier point / longueur du sommet jusqu'au second point.};
\end{tikzpicture}
\end{minipage}\hfill
...
\vspace{0.24cm}
{\bfseries\color{brandNavy}\fontsize{11.4}{12.2}\selectfont Je choisis puis je calcule les deux rapports}\par\vspace{0.04cm}
\begin{center}
$\begin{array}{rcl}
...
{\bfseries\color{brandNavy} Je calcule et je compare.}\par
\[
...
{\bfseries\color{brandNavy} Je vérifie alors la disposition.}\par
Les points sont placés de la même façon sur les deux droites : $A-M-B$ et $A-N-C$.\par\vspace{0.10cm}
{\bfseries\color{brandTeal} Je conclus.}\par
...
\end{minipage}\hfill
\begin{minipage}[c]{11.50cm}
{\bfseries\color{brandNavy} Je vérifie le contexte.}\par
...
{\bfseries\color{brandOrange} Je conclus.}\par
