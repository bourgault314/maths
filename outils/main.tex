...
\begin{tikzpicture}[scale=0.80, every node/.style={font=\bfseries\small}]
    ...
    \path[use as bounding box] (0, 8.8) rectangle (\W, -24.0);
    \def\Xstep{-3.5}
    ...
    % 1ère part
    \node[overlay, anchor=east] at (-0.2, 6.9) {1\iere\ part : ....................};
    ...
    \draw [decorate, decoration={brace, amplitude=5pt, mirror}, thick] (0, -3.9) -- (1.2, -3.9) node [midway, below=4pt] {1\iere\ part};
    ...
    \draw [decorate, decoration={brace, amplitude=5pt, mirror}, thick] (0, -14.0) -- (1.2, -14.0) node [midway, below=4pt] {1\iere\ part};
