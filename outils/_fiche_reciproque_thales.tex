...
\begin{center}
\begin{tikzpicture}
\node[rounded corners=7pt,draw=brandOrange!55,fill=softOrange!38,line width=0.65pt,text width=17.95cm,inner sep=5pt,align=center] {J'utilise l'égalité des produits en croix.};
\end{tikzpicture}
\end{center}
\Sep
...
\vspace{0.04cm}
\begin{tikzpicture}
\node[rounded corners=7pt,draw=brandOrange!55,fill=softOrange!38,line width=0.65pt,text width=12.60cm,inner sep=5.0pt,align=center] {\bfseries\color{brandNavy} J'utilise l'égalité des produits en croix.};
\end{tikzpicture}
