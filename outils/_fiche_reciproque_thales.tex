...
\begin{tikzpicture}[scale=#1,line cap=butt,line join=miter]
  ...
  \node[brandBlue,font=\bfseries\scriptsize] at (3.10,0.36) {$(MN)$};
  \node[brandTeal,font=\bfseries\scriptsize] at (5.56,0.64) {$(BC)$};
\end{tikzpicture}}
...
\begin{tikzpicture}[scale=#1,line cap=butt,line join=miter]
  ...
  \node[brandBlue,font=\bfseries\scriptsize] at (-2.60,-0.18) {$(MN)$};
  \node[brandTeal,font=\bfseries\scriptsize] at (3.56,0.46) {$(BC)$};
\end{tikzpicture}}
