...
{\fontsize{9.6}{10.3}\selectfont Les points $A,M,B$ sont alignés. Les points $A,N,C$ sont alignés. Les droites $(MN)$ et $(BC)$ sont parallèles.}\par\vspace{0.05cm}
...
\substack{\text{Triangle }\Apt\Mpt\Npt\\\text{(en cm)}} & \AMcol & \ANcol & \MNcol\\ \hline
\substack{\text{Triangle }\Apt\Bpt\Cpt\\\text{(en cm)}} & \ABcol & \ACcol & \BCcol\\ \hline
...
\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-4.10) {2};
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-3.96) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont J'associe.\par\vspace{0.04cm}{\scriptsize\bfseries\color{brandNavy} Une longueur du petit triangle avec la longueur correspondante du grand.}};

\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-7.45) {3};
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-7.31) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont J'écris Thalès.\par\vspace{0.04cm}{\scriptsize\bfseries\color{brandNavy} Les trois rapports dans le même ordre.}};

\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-10.85) {4};
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-10.71) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont Je calcule.\par\vspace{0.04cm}{\scriptsize\bfseries\color{brandNavy} Je garde la colonne de l'inconnue et une colonne complète, puis j'utilise les produits en croix.}};

\node[circle,fill=brandNavy,text=white,font=\bfseries,minimum size=0.52cm,inner sep=0pt] at (0.47,-14.30) {5};
\node[anchor=north west,text width=3.92cm,align=left] at (0.84,-14.16) {\bfseries\color{brandNavy}\fontsize{10.2}{10.9}\selectfont Je conclus.\par\vspace{0.04cm}{\scriptsize\bfseries\color{brandNavy} Je donne la longueur avec son unité.}};

\node[rounded corners=7pt,draw=brandOrange!55,fill=softOrange!45,line width=0.65pt,text width=4.45cm,inner sep=5pt,align=center] at (2.55,-18.78) {\scriptsize\bfseries\color{brandNavy} Avant tout calcul, je dois avoir les alignements et le parallélisme.};
\end{tikzpicture}
\end{minipage}\hfill
