...
\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=south west,inner sep=0pt] at ([xshift=0.48cm,yshift=0.26cm]current page.south west)
    {\IfFileExists{\LogoFile}{\includegraphics[width=2.45cm]{\LogoFile}}{\tikz[baseline=-0.6ex]{\node[brandNavy,font=\sffamily\bfseries\fontsize{17}{18}\selectfont]{M};}}};
  ...
  \node[anchor=south east,text=brandNavy!70,font=\sffamily\fontsize{6.8}{6.8}\selectfont]
    at ([xshift=-0.48cm,yshift=0.32cm]current page.south east) {Gabarit plastifiable};
\end{tikzpicture}%
}
